...
```bash
wget [https://raw.githubusercontent.com/amircyb/Geo-Router-Loadbalancer/main/bloodcyb.sh](https://raw.githubusercontent.com/amircyb/Geo-Router-Loadbalancer/main/bloodcyb.sh)
```
